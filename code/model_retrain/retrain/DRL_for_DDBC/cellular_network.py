...
class CellularNetwork:
    ...
    def save_models(self):
        for bs in self.bs_list:
            bs.dqn.save_model(bs.index)
        print('All the DQN models have been saved!')

    def load_weights(self):
        for bs in self.bs_list:
            bs.dqn.load_weights(bs.index)
        print('All the weights have been loaded!')
